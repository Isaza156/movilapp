        ...
        <div className="container mb-5">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-text">
                Los buseteros de bello compiten por recoger pasajeros y están
                poniendo en riesgo la vida de nosotros.
                <span className="text-info">
                  #buseteros#busesbello#bello#masrespetoconlospasajeros
                </span>
              </p>
          ...
          <div className="card mt-3">
            <div className="card-body">
              ...
              <p className="card-text">
                Normalmente un viaje de san antonio a la estrella demora 25
                minutos, pero la mayoría de veces esta demorando mas de 40
                minutos porque para antes de llegar a cada estación.
                <span className="text-info">
                  #metromedellin#elmetroeslento#movilidadagil
                </span>
              </p>
              <div className="d-flex justify-content-between pt-3">
                <div>
          ...
          <div className="card mt-3">
            <div className="card-body">
              ...
              <p className="card-text">
                Se ha vuelto costumbre ver accidentes en la vía robledo por
                huecos, muy peligrosas esas calles
                <span className="text-info">
                  #robledo#viasconhuecos#arreglarvias#noserobeneldinero
                </span>
              </p>
              <div className="d-flex justify-content-between pt-3">
                <div>

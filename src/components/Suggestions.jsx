        ...
        <div className="container mb-5">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-text">
                Vivo en el norte de la ciudad y me movilizo hacía el sur todos los días, y quisiera hacerlo en bicicleta pero las ciclo rutas no cruzan toda la ciudad, sería excelente si implementaran más.
          ...
          <div className="card mt-3">
            <div className="card-body">
              ...
              <p className="card-text">
                Me gustaría que implementaran mas buses de caldas hacía medellín, ya que diario nos toca esperar hasta 50 minutos que pase un bus y si pasa lleno, no para, entonces es otra media hora más. 
          ...
          <div className="card mt-3">
            <div className="card-body">
              ...
              <p className="card-text">
                Creo que deberían extender el pico y placa ambiental por siempre, aplicado incluso a motos 4 tiempos, esto disminuira la cantidad de vehiculos circulando en los mismos horarios y mermarian los tacos. 
                <span className="text-info"> #picoyplacaambiental #maspicoyplaca #menostrancon</span>
              </p>
              <div className="d-flex justify-content-between pt-3">
                <div>
                <i className="fas fa-heart text-danger fa-2x"></i>
